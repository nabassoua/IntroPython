...
val_min = int(input('Donnez une valeur minimale : '))
val_max = int(input('Donnez une valeur maximale : '))
...
while nb_a_trouver != proposition:  # tant que l'utilisateur n'a pas trouvé
    ...
    proposition = int(input("Proposez un nombre compris entre %d et %d : " % (val_min, val_max)))
